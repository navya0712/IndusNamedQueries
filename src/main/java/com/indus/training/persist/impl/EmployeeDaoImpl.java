...
public class EmployeeDaoImpl implements IEmployeeDao {
	...
	public List<Employee> findAll() throws EmployeeDaoException {
		...
		try {
			...
			throw new EmployeeDaoException("An error occurred while fetching the employee list");
		} 
		return employees;
	}

	@Override
	public List<Employee> findByLastName(String lastName) throws EmployeeDaoException{
		Session session = null;
		List<Employee> employees = null;
		try {
			session = HibernateUtil.getSessionFactory().getCurrentSession();
			session.beginTransaction(); 
			Query query = session.getNamedQuery("Employee.findByLastName");
			...
			throw new EmployeeDaoException("An error occurred while fetching the employee By Last");
		} 
		return employees;
	}
